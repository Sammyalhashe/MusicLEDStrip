...
import com.example.audiocapture.Services.AudioCaptureService;
import com.example.audiocapture.Services.BluetoothService;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void createBluetoothConnectionWithBoundService() {
        Log.d(TAG, "Creating Intent for Bluetooth Service");
        Intent intent = new Intent(this, AudioCaptureService.class);
        bindService(intent, bluetoothConnection, Context.BIND_AUTO_CREATE);
        Log.d(TAG, "After Intent for Bluetooth Service");
    }
    ...
    protected void onStart() {
        ...
        //this.createBluetoothConnectionWithBoundService();
    ...
    private ServiceConnection bluetoothConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            mBTBound = true;
            AudioCaptureService.AudioBinder binder = (AudioCaptureService.AudioBinder) service;
            audioCaptureService = binder.getService();
            Log.d(TAG, "AudioCaptureService Connected after");
            bluetoothService.run(audioCaptureService);
            Toast.makeText(_context, "AudioCaptureService started", Toast.LENGTH_LONG);
            setupBTCollection();
        }
        ...
        public void onServiceDisconnected(ComponentName name) {
            ...
            Log.d(TAG, "AudioCaptureServuce disconnected");
        }
    };
    ...
    private void setupBTCollection() {
        Log.i(TAG, "setupBTCollection");
        try {
            audioCaptureService.startService();
            Toast.makeText(this, "audio capture service started", Toast.LENGTH_LONG);
        } catch (IOException e) {
            Log.e(TAG, "AudioCaptureService :: startService() failed", e);
            Toast.makeText(this, "audio capture service failed", Toast.LENGTH_LONG);
        }
    }
